        ...
        <div className="relative isolate">
          ...
          <div className="mx-auto max-w-7xl px-6 py-12 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-24">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <h1 className="max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-8xl">
                SkyHarbor
              </h1>
              <p className="text-blue-500 mt-2 max-w-lg text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">
                Buy and sell NFTs.
              </p>
